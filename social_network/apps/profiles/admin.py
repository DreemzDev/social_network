...
class UserAdmin(admin.ModelAdmin):
    list_display = ('id','cat','last_activity', 'avatar', 'position', 'rank','last_name', 'first_name', 'patronymic', 'birthday', 'phone_pts','phone_city','phone_zs','phone_9','phone_hc' ) #Список полей которые мы видим в админке
