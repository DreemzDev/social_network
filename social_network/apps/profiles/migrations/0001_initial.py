...
class Migration(migrations.Migration):
    ...
    operations = [
        # Справочник подразделений жил отдельным приложением `category`;
        # оно удалено, а модель переехала сюда — см. SESSION_CONTEXT,
        # «Архитектурный долг».
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='profiles.category', verbose_name='Категории')),
